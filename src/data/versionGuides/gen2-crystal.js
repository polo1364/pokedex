...
import { crystalLeague } from './gen2-crystal-league.js';
...
const league = crystalLeague;
assertLeague(league);

export const crystalGuide = {
  id: 'crystal',
  title: '寶可夢 水晶',
  displayGeneration: 2,
  status: 'complete',
  notes: '水晶版道館、四天王、冠軍隊伍與金／銀相同。另有水君等三聖獸劇情與寶可夢動畫；通關後白銀山赤紅為後日談，不在本攻略範圍。',
  gyms: [
    gymFalkner,
    gymBugsy,
    gymWhitney,

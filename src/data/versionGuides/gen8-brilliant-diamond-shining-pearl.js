...
import { brilliantDiamondShiningPearlLeague } from './gen8-brilliant-diamond-shining-pearl-league.js';
...
const gymMaylene = {
  ...
  badge: '帷幕徽章',
  badgeType: 'fighting',
  notes: 'BDSP 道館戰為瑪沙那與火爆猴；路卡利歐於通關後劇情再戰。',
  party: [
    pm('瑪沙那', ['fighting', 'psychic'], 17),
    pm('火爆猴', ['fighting'], 19),
  ],
  recommendedTeams: [
    ...
    rec('超能剋制隊', '瑪沙那超能格鬥雙屬，惡系與鬼系效果佳；飛行系優先處理火爆猴。', [
      pm('姆克鷹', ['normal', 'flying']),
      pm('勒克貓', ['electric']),
      pm('波皇子', ['water']),
      pm('猛火猴', ['fire', 'fighting']),
...
const league = brilliantDiamondShiningPearlLeague;
assertLeague(league);

export const brilliantDiamondShiningPearlGuide = {
  id: 'brilliant-diamond-shining-pearl',
  title: '寶可夢 晶燦鑽石／明亮珍珠',
  displayGeneration: 8,
  status: 'complete',
  notes: '晶燦鑽石與明亮珍珠道館、四天王、冠軍隊伍相同。BDSP 重製版無 Mega 進化，聯盟與鑽石／珍珠相同（非白金四天王差異）；無反轉世界與戰鬥開拓區。',
  gyms: [
    gymRoark,
    gymGardenia,
    gymMaylene,

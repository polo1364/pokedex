...
import { rubySapphireLeague } from './gen3-ruby-sapphire-league.js';
...
const gymWallace = {
  ...
  party: [
    pm('愛心魚', ['water'], 40),
    pm('鯰魚王', ['water', 'ground'], 42),
    pm('美納斯', ['water'], 43),
  ],
  recommendedTeams: [
    rec('草電雙剋隊', '樂天河童草系對水效果絕佳；雷電獸打愛心魚與美納斯。鯰魚王水地面，用草系優先。', [
      pm('樂天河童', ['water', 'grass']),
      pm('雷電獸', ['electric']),
      pm('蘑蘑菇', ['grass', 'fighting']),
      pm('水躍魚', ['water', 'ground']),
    ...
    rec('草系核心隊', '蓮葉童子一路進化樂天河童；電系補刀。美納斯會用恢復，建議高威力草招秒殺。', [
      pm('樂天河童', ['water', 'grass']),
      pm('雷電獸', ['electric']),
      pm('木守宮', ['grass']),
      pm('奇魯莉安', ['psychic']),
...
const championSteven = {
  ...
  specialty: 'steel',
  party: [
    pm('盔甲鳥', ['steel', 'flying'], 57),
    pm('念力土偶', ['ground', 'psychic'], 58),
    pm('波士可多拉', ['steel', 'rock'], 57),
    pm('搖籃百合', ['rock', 'grass'], 57),
    pm('太古盔甲', ['rock', 'bug'], 56),
    pm('巨金怪', ['steel', 'psychic'], 58),
  ],
};
assertBattle(championSteven);

const league = rubySapphireLeague;
assertLeague(league);

export const rubySapphireGuide = {
  id: 'ruby-sapphire',
  title: '寶可夢 紅寶石／藍寶石',
  displayGeneration: 3,
  status: 'complete',
  notes: '紅版與藍版道館、四天王、冠軍隊伍相同。第 8 道館為米可利，冠軍為大吾。小楓與小南為雙打道館。',
  gyms: [
    gymRoxanne,
    gymBrawly,
    gymWattson,
